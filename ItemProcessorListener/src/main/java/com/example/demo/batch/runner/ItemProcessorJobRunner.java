...
@Component
public class ItemProcessorJobRunner 
{
	private static final Logger logger = LoggerFactory.getLogger(ItemProcessorJobRunner.class);

	@Autowired
	JobLauncher simpleJobLauncher;

	@Autowired
	Job itemProcessorJob;
	...
	public void runBatchJob() 
	{
		...
		runJob(itemProcessorJob, jobParametersBuilder.toJobParameters());
	}
