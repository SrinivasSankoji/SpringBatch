...
@Component
public class ExecutionContextJobRunner 
{
	private static final Logger logger = LoggerFactory.getLogger(ExecutionContextJobRunner.class);
	...
	public void runBatchJob() 
	{
		...
		executionContext.putString("fileName", "employeee.csv");
