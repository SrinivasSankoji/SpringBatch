...
@Component
public class CustomReaderJobRunner 
{
	private static final Logger logger = LoggerFactory.getLogger(CustomReaderJobRunner.class);
	...
	public void runBatchJob() 
	{
		...
		runJob(customReaderJob, jobParametersBuilder.toJobParameters());
	}
