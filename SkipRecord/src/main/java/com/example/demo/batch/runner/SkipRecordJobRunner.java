...
@Component
public class SkipRecordJobRunner 
{
	private static final Logger logger = LoggerFactory.getLogger(SkipRecordJobRunner.class);

	@Autowired
	JobLauncher skipRecordLauncher;
	...
	public void runBatchJob() 
	{
		...
		runJob(skipRecordJob, jobParametersBuilder.toJobParameters());
	}

	public void runJob(Job job, JobParameters parameters) 
	{
		try {
			JobExecution jobExecution = skipRecordLauncher.run(job, parameters);
