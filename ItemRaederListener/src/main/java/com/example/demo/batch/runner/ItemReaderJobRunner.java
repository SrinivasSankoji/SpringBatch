...
@Component
public class ItemReaderJobRunner 
{
	private static final Logger logger = LoggerFactory.getLogger(ItemReaderJobRunner.class);
	...
	public void runBatchJob() 
	{
		...
		runJob(itemReaderJob, jobParametersBuilder.toJobParameters());
	}
