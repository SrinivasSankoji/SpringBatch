...
import com.example.demo.batch.listener.JobListenerListener;
...
public class JobListener 
{
    ...
    @Qualifier(value = "jobListenerJob")
    @Bean
    public Job jobListenerJob() throws Exception 
    {
        return jobBuilderFactory.get("jobListenerJob")
	            .start(step1jobListenerJob())
	            .listener(jobListenerListener())
	            .build();
    }

    @Bean
    public Step step1jobListenerJob() throws Exception {
    ...
    @Bean 
    public JobListenerListener jobListenerListener()
    {
    	return new JobListenerListener();
    }
